...
description: Gemini API 기반 PR 자동 리뷰 workflow
provides:
  - .github/workflows/ai-review-gemini.yml
  - docs/ai-review-gemini.md
requires: []
works-with:
...
after-import:
  ...
  - 모델/비용 정책 확인 (GEMINI_REVIEW_MODEL variable로 모델 변경 가능)
verify:
  - actionlint .github/workflows/ai-review-gemini.yml
---
...
`GEMINI_API_KEY` secret만 등록하면 PR 리뷰가 즉시 동작합니다. secret이 없으면
