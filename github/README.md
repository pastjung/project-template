...
| --- | --- | --- |
| `github/pr-template` | 브랜치 타입별 Pull Request 템플릿 | `.github/PULL_REQUEST_TEMPLATE/`, `docs/github-pr-template.md` |
| `github/issue-template` | 용도별 Issue 템플릿 | `.github/ISSUE_TEMPLATE/`, `docs/github-issue-template.md` |
| `github/labels` | GitHub 라벨 운영 기준과 라벨 정의 | `.github/labels.json`, `docs/github-labels.md` |
| `github/semantic-pr` | PR 제목을 Conventional Commits 형식으로 검사하는 workflow | `.github/workflows/semantic-pr.yml`, `docs/github-semantic-pr.md` |
| `github/stale-issues` | 오래된 issue와 PR을 표시하고 정리하는 workflow | `.github/workflows/stale-issues.yml`, `docs/github-stale-issues.md` |
| `github/slack-notification` | GitHub 이벤트 Slack 알림 workflow | `.github/workflows/slack-notification.yml`, `docs/github-slack-notification.md` |
| `github/codeowners` | 경로별 code owner와 리뷰 담당 기준 | `.github/CODEOWNERS`, `docs/github-codeowners.md` |
| `github/ci` | 스택 자동 감지 빌드/테스트 CI | `.github/workflows/ci.yml`, `docs/github-ci.md` |
| `github/dependabot` | 의존성 자동 업데이트 | `.github/dependabot.yml`, `docs/github-dependabot.md` |
| `github/release` | release-please 릴리즈 자동화 | `.github/workflows/release-please.yml`, `docs/github-release.md` |
| `github/community` | CONTRIBUTING, SECURITY | `CONTRIBUTING.md`, `SECURITY.md`, `docs/github-community.md` |
...
- `github/semantic-pr`는 `standards/commit-strategy`의 commit type과 같은 기준을 사용합니다.
...
```bash
git merge --squash origin/github/ci
git commit -m "init: add CI workflow"
```
...
```bash
git merge --squash origin/github/dependabot
git commit -m "init: add dependabot config"
```
...
```bash
git merge --squash origin/github/release
git commit -m "init: add release automation"
```
...
```bash
git merge --squash origin/github/community
git commit -m "init: add community health files"
```
